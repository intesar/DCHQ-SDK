...
public class DataCenterUpdateServiceTest extends AbstractServiceTest {
    ...
    public DataCenterUpdateServiceTest(String clusterName, Boolean autoScaleFlag, EntitlementType blueprintType, String updatedName, String validationMessage, boolean success) {
    ...
    public void testUpdate() throws Exception {
        ...
        if (!response.isErrors() && response.getResults() != null) {
            ...
            this.dataCenterCreated.setName(updatedName);
