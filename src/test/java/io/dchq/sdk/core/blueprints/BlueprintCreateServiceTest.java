...
public class BlueprintCreateServiceTest extends AbstractServiceTest {
    ...
    public BlueprintCreateServiceTest(String gname, String yaml, BlueprintType blueprintTpe,
                                      ...
                                      Boolean isInactive, EntitlementType entitlementType, String username, String customText,
                                      String externalLink, String leaseTime, String shortDescription, String tags,
                                      Map<String,String> customMap,Boolean editable, boolean success) {
    ...
    public static Collection<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                {null, null, null, null, null, "All Nulls", null, null, null, null,null,null,null,null,null,null,false},
                {"Build Test", null, null, null, null, "Null Yaml", null, null, null, null,null,null,null,null,null,null,false},
                {"Build Test", "LB:\n image: nginx:latest\n", null, null, null, "without EntitleMent Type", null, null, null, null,null,null,null,null,null,null,false},
                {"bUild Test", "LB:\n image: nginx:latest\n", BlueprintType.DOCKER_COMPOSE, null, null, "General Input", null, null, "admin@dchq.io", null,null,null,null,null,null,null,false},
                {"bUild Test", "LB:\n image: nginx:latest\n", BlueprintType.DOCKER_COMPOSE, null, null, "General Input", null, null, null, null,null,null,null,null,null,null,false},
                {"bUild Test", "LB", BlueprintType.DOCKER_COMPOSE, null, null, "invalid YAML", null, null, null, null,null,null,null,null,null,null,false},

                {"Build Test", "LB:\n image: nginx:latest\n", BlueprintType.DOCKER_COMPOSE, null, null, "General Input", true, null, null, null,"http://wwww.dchq.io","2 Years", null, null, null, null,false},
               /* {"Build Test", "LB:\n image: nginx:latest\n", BlueprintType.DOCKER_COMPOSE, null, null, "General Input", true, null, null, null,"http://wwww.dchq.io",null,"getShortDescription","tags 1",null,null,false},*/
                {"Build Test", "LB:\n image: nginx:latest\n", BlueprintType.DOCKER_COMPOSE, null, null, "General Input", true, null, null, " Aa ",null,null,null,null,null,null,false},
                {"Build Test", "LB:\n image: nginx:latest\n", BlueprintType.DOCKER_COMPOSE, null, null, "General Input", true, null, null, null,"http://wwww.dchq.io",null,"getShortDescription",null,map3,null,false},
                {"Build Test", "LB:\n image: nginx:latest\n", BlueprintType.DOCKER_COMPOSE, null, null, "General Input", null, null, null, null,null,null,null,null,null,null,false},
    ...
    public void testCreate() throws Exception {
        ...
        if (!error) {
            ...
            else Assert.assertEquals(" Editable ", bluePrint.getEditable(), bluePrintCreated.getEditable());
